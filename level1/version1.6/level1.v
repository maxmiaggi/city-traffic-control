...
// version 1.4: Successful compilation and synthesis in Altera (06-03-2013), Error in Functional Verification
// version 1.5: Successful Functional Verification of v1.4 in ModelSim (18-03-2013)
// version 1.6: Implemented clock division and hardware implementation (04-04-2013) - Incorrect Output
...
module level1(T, T1, T2, T3, T4, S1, S2, S3, S4, clk, clear, delay_counter);
  ...
  input   clk, clear;				// 'clk' is input from the board. 25MHz.   
  ...
  *****/
  ...
  begin
	...
	else if(clkdiv == 25'b1_0110_1110_0011_0110_0000_0000) begin		// 25M = 25'b1_0111_1101_0111_1000_0100_0000 and 24M = 25'b1_0110_1110_0011_0110_0000_0000
		clock = 1'b1;
		clkdiv = 1'b0;
	end
	// else if (clkdiv > 25'b1_0111_1101_0111_1000_0100_0000) begin
	else begin
		clock = 1'b0;
		clkdiv = clkdiv + 1;
	end		// end of if-else
